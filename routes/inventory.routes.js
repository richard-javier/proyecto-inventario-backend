...
// IMPORTAMOS TUS DOS FUNCIONES NUEVAS DE INGRESOS
...
router.get('/lotes', protegerRuta, obtenerHistorialLotes); // <-- LÍNEA NUEVA
router.post('/lotes', protegerRuta, verificarRol([1, 2, 4]), crearLote);

// === AQUÍ ESTÁN TUS DOS NUEVAS RUTAS DE RECEPCIÓN (SINCOT) ===
